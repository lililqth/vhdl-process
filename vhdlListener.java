...
public interface vhdlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link vhdlParser#ranges}.
	 * @param ctx the parse tree
	 */
	void enterRanges(vhdlParser.RangesContext ctx);
	/**
	 * Exit a parse tree produced by {@link vhdlParser#ranges}.
	 * @param ctx the parse tree
	 */
	void exitRanges(vhdlParser.RangesContext ctx);
	/**
